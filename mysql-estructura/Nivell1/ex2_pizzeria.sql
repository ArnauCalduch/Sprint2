...
create table clients (
	...
	foreign key (id_adreça) references adreçes(id_adreça)
);
...
insert into localitats (id_localitat,nom)
values (1,"Barcelona");
...
insert into adreçes (id_adreça,id_localitat,id_provincia,carrer,numero,pis,porta)
values (1,1,1,"Leiva",85,3,5);

insert into adreçes (id_adreça,id_localitat,id_provincia,carrer,numero,pis,porta)
values (2,1,1,"Almeria",13,2,1);

insert into adreçes (id_adreça,id_localitat,id_provincia,carrer,numero,pis,porta)
values (3,1,1,"Vilardell",18,0,1);

insert into adreçes (id_adreça,id_localitat,id_provincia,carrer,numero,pis,porta)
values (4,1,1,"Provença",332,0,1);

-------------------------------------------------------

insert into clients (id_client,id_adreça,nom,cognoms,codi_postal,telefon)
...
insert into botigues (id_botiga,id_adreça,codi_postal)
values (1,3,08014);
...
insert into productes (id_producte,id_categoria,nom,descripcio,imatge,preu)
values (1,1,"Pizza Quatre formatges","Clàssica i tradicional, elaborada amb la barreja de formatges mozzarella, emmental, Edam i formatge blau.","pizza-4-formatges.jpg",9.50);

insert into productes (id_producte,id_categoria,nom,descripcio,imatge,preu)
values (2,2,"Pizza Mallorquina","Amb sobrassada de Mallorca i mel, aconseguim un contrast de sabors molt desitjables al paladar.","pizza-mallorquina.jpg",10.50);

insert into productes (id_producte,id_categoria,nom,descripcio,imatge,preu)
values (3,3,"Pizza Spinaci","Amb espinacs frescos trossejades, formatge de cabra i una mica de mel, al final, un cop fora del forn, incorporem les nous trossejades.","pizza-espinacs.jpg",12.50);

insert into productes (id_producte,id_categoria,nom,descripcio,imatge,preu)
values (4,null,"Hamburguesa amb Formatge","Formatge cheddar fos sobre carn de boví, enciam batavia, tomàquet, maionesa i pa clàssic.","cheeseburger.jpg",10.50);

insert into productes (id_producte,id_categoria,nom,descripcio,imatge,preu)
values (5,null,"Hamburguesa Pulled Pork","Carn de porc esfilagarsada sobre carn de boví amb salsa BBQ, formatge Cheddar, tomàquet i enciam Batavia. Amb pa clàssic i salsa maig Smoked Bacon.","pulled-pork.jpg",14.50);

insert into productes (id_producte,id_categoria,nom,descripcio,imatge,preu)
values (6,null,"Hamburguesa amb Bacon","Bacó, carn de boví, patates fregides, barreja d'enciams, tomàquet a rodanxes, maionesa i pa clàssic.","bacon-burger.jpg",12.50);

insert into productes (id_producte,id_categoria,nom,descripcio,imatge,preu)
values (7,null,"Aigua","Aigua fresca d'1,5L","aigua.jpg",0.50);

insert into productes (id_producte,id_categoria,nom,descripcio,imatge,preu)
values (8,null,"Coca-Cola","Coca-cola normal d'1,5L","cola.jpg",1.20);

insert into productes (id_producte,id_categoria,nom,descripcio,imatge,preu)
values (9,null,"Estrella Damm","Cervesa Estrella de 0,25L","estrella.jpg",1.0);
